...
function PreQuoteNameEditor({
  ...
  if (readOnly) {
    return (
      <DetailField
        label="Nombre"
        value={preQuote.name ?? "Sin nombre asignado"}
      />
    );
  }
    ...
    <div className="min-w-0 space-y-6">
      ...
      >
        <section
          ...
          aria-labelledby="prequote-project-title"
        >
          <h2
      ...
      >
        <section
          className="p-5 sm:p-6"
          aria-labelledby="prequote-detail-title"
        >
          <h2
          ...
          <dl className="mt-5 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            ...
            <DetailField
              label="Proyecto"
              value={preQuote.projectId}
            />

            <DetailField
              label="Fecha de creacion"
              value={formatPreQuoteDateTime(
